    ...
    return (
      <div className="main-container">
        <div className="row-top">
          ...
          <br/>
            <label className='title'>Bet with your <b className='title-bold'>LUCKIEST</b> number</label>
            <br/>
            <label className='body-text'>- - - - - - - - - - - - - - - - - - - -</label>
            <br/>
            <label className='title2'>Win <b className='title2-bold'>HUGE</b > amounts of <b className='title2-bold'>ETHER</b> !!</label>
          </div>
        </div>
        ...
        <div className="row-body">
          <div className="col-body-front">
            <br/><br/><br/>
            <div className="block">
              <b className='ttext'><i class='fas fa-chess-queen ggold'></i>&nbsp;&nbsp;&nbsp;&nbsp;Timer:</b> &nbsp;
              <span ref="timer"> {this.state.timer}</span>
            </div>
            <br/>
            <div className="block">
              <b className='ttext'><i class='fas fa-chess-queen ggold'></i>&nbsp;&nbsp;&nbsp;&nbsp;Number of bets:</b> &nbsp;
              <span>{this.state.numberOfBets}</span>
            </div>
            <br/>
            <div className="block">
              <b className='ttext'><i class='fas fa-chess-queen ggold'></i>&nbsp;&nbsp;&nbsp;&nbsp;Last winner:</b> &nbsp;
              <span>{this.state.lastWinner}</span>
            </div>
            <br/>
            <div className="block">
              <b className='ttext'><i class='fas fa-chess-queen ggold'></i>&nbsp;&nbsp;&nbsp;&nbsp;Total ether bet:</b> &nbsp;
              <span>{this.state.totalBet} ether</span>
            </div>
            <br/>
            <div className="block">
              <b className='ttext'><i class='fas fa-chess-queen ggold'></i>&nbsp;&nbsp;&nbsp;&nbsp;Minimum bet:</b> &nbsp;
              <span>{this.state.minimumBet} ether</span>
            </div>
            <br/>
            <div className="block">
              <b className='ttext'><i class='fas fa-chess-queen ggold'></i>&nbsp;&nbsp;&nbsp;&nbsp;Max amount of bets:</b>&nbsp;
